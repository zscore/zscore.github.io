...
These were solved to the first order by Michael Hassin, but inevitably early solutions break down as more data are gathered.

I ended up solving this problem in a somewhat satisfactory way, enough at least to expiate my guilt at working for an auto insurance company. A video of my presentation can be found here: https://www.youtube.com/watch?v=kGIMsdWO7tE
...
2. You can hire an engineering firm to go around streets with a laser truck and measure the actual characteristics of the data: http://www.acuitylaser.com/products/category/road-profiling
